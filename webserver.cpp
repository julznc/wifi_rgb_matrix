...
"<input type=\"radio\" name=\"bitmap\" value=\"1\" onclick=\"this.form.submit();\">\"STOP\"</input><br/><br/>"
"<input type=\"radio\" name=\"bitmap\" value=\"2\" onclick=\"this.form.submit();\">\"BABY ON CAR\"</input><br/><br/>"
"<input type=\"radio\" name=\"bitmap\" value=\"3\" onclick=\"this.form.submit();\">\"PREGGY ON CAR\"</input><br/>"
"</form>"
